<?php
/**
 * E2M Connect MCP - Get Product Tag.
 *
...
wp_register_ability( 'e2m/get-product-tag', [
	'label'       => __( '[WooCommerce] Get Product Tag', 'e2mconnect' ),
	'description' => 'Returns a single WooCommerce product tag by term ID.',
	...
	'execute_callback'    => 'e2m_engine_get_product_tag_ability',
 ...
 */
function e2m_engine_get_product_tag_ability( array $input ) {
